    ...
    <div class="card card-body mt-2 mb-4">
        ...
        @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea id="message" class="form-control{{ $errors->has('message') ? ' is-invalid' : '' }}" name="message" rows="4"></textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea id="shipping_address" class="form-control{{ $errors->has('shipping_address') ? ' is-invalid' : '' }}" name="shipping_address" rows="4">{!! Auth::check() ? Auth::user()->shipping_address : ''  !!}</textarea>
