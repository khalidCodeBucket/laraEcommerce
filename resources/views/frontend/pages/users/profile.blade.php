    ...
    <div class="card-body mb-5">
      ...
      @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <textarea id="street_address" class="form-control{{ $errors->has('street_address') ? ' is-invalid' : '' }}" name="street_address" rows="4">{!! $user->street_address !!}</textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <textarea id="shipping_address" class="form-control{{ $errors->has('shipping_address') ? ' is-invalid' : '' }}" name="shipping_address" rows="4">{!! $user->shipping_address !!}</textarea>
